...
namespace cnpy {
    ...
    template<typename T> 
    inline void npy_save(std::string fname, const T* data, const std::vector<size_t> shape, std::string mode) {
        FILE* fp = NULL;
    ...
    template<typename T> 
    inline void npz_save(std::string zipname, std::string fname, const T* data, const std::vector<size_t>& shape, std::string mode)
    {
    ...
    template<typename T> 
    inline void npy_save(std::string fname, const std::vector<T> data, std::string mode) {
        std::vector<size_t> shape;
    ...
    template<typename T> 
    inline void npz_save(std::string zipname, std::string fname, const std::vector<T> data, std::string mode) {
        std::vector<size_t> shape;
        shape.push_back(data.size());
