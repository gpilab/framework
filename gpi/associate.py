...
bind_1  = ('.bmp',     'gpi_core.fileIO.ReadImage',   'File Browser')
bind_2  = ('.csv',     'gpi_core.fileIO.ReadCSV',     'File Browser')
bind_3  = ('.dcm',     'gpi_core.fileIO.ReadDICOM',   'File Browser')
bind_4  = ('.gif',     'gpi_core.fileIO.ReadImage',   'File Browser')
bind_5  = ('.h5',      'gpi_core.fileIO.ReadHDF5',    'File Browser')
bind_6  = ('.hdf5',    'gpi_core.fileIO.ReadHDF5',    'File Browser')
bind_7  = ('.jpeg',    'gpi_core.fileIO.ReadImage',   'File Browser')
bind_8  = ('.jpg',     'gpi_core.fileIO.ReadImage',   'File Browser')
bind_9  = ('.mat',     'gpi_core.fileIO.ReadMatlab',  'File Browser')
bind_10 = ('.mridata', 'gpi_core.fileIO.ReadMRIData', 'File Browser')
bind_11 = ('.npy',     'gpi_core.fileIO.ReadNPY',     'File Browser')
bind_12 = ('.pickle',  'gpi_core.fileIO.ReadPickled', 'File Browser')
bind_13 = ('.pkl',     'gpi_core.fileIO.ReadPickled', 'File Browser')
bind_14 = ('.png',     'gpi_core.fileIO.ReadImage',   'File Browser')
bind_15 = ('.raw',     'gpi_core.fileIO.ReadRaw',     'File Browser')
