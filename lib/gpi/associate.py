...
bind_1 = ('.csv', 'core.fileIO.ReadCSV', 'File Browser')
bind_2 = ('.data', 'core.fileIO.ReadPhilips', 'File Browser')
bind_3 = ('.hdf5', 'core.fileIO.ReadHDF5', 'File Browser')
bind_4 = ('.jpg', 'core.fileIO.ReadImage', 'File Browser')
bind_5 = ('.lab', 'core.fileIO.ReadPhilips', 'File Browser')
bind_6 = ('.list', 'core.fileIO.ReadPhilips', 'File Browser')
bind_7 = ('.mat', 'core.fileIO.ReadMatlab', 'File Browser')
bind_8 = ('.npy', 'core.fileIO.ReadNPY', 'File Browser')
bind_9 = ('.par', 'core.fileIO.ReadPhilips', 'File Browser')
bind_10 = ('.pickle', 'core.fileIO.ReadPickled', 'File Browser')
bind_11 = ('.png', 'core.fileIO.ReadImage', 'File Browser')
bind_12 = ('.raw', 'core.fileIO.ReadRaw', 'File Browser')
bind_13 = ('.rec', 'core.fileIO.ReadPhilips', 'File Browser')
bind_14 = ('.sin', 'core.fileIO.ReadPhilips', 'File Browser')
bind_15 = ('.xml', 'core.fileIO.ReadPhilips', 'File Browser')
